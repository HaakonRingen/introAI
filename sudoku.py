...
ac_3_result = csp.ac_3()
backtracking_search_result = csp.backtracking_search()
end_time = time.time()
total_time = end_time - start_time

print(f"Total time ac_3 + backtracking_search: {total_time}")
print(ac_3_result)
print_solution(backtracking_search_result)
